    ...
    <div className="min-h-screen bg-blue-500 flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="relative z-10 bg-white rounded-3xl shadow-2xl px-10 py-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Login to Account</h1>
          <p className="text-sm text-gray-400">Please enter your email and password to continue</p>
        </div>
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-colors shrink-0
                ${remember ? "bg-blue-500 border-blue-500" : "border-gray-300 bg-white"}`}
            >
              {remember && (
            ...
            <span className="text-sm text-gray-600 select-none">Remember Password</span>
          </div>
