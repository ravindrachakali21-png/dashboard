...
export default function AddContact({ onBack, onAdd }) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-sm text-gray-700 placeholder-gray-300 outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-300 transition"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-300 transition appearance-none cursor-pointer"
                >
